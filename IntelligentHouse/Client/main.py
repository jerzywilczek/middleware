...
if __name__ == '__main__':
    with Ice.initialize(sys.argv) as communicator:
        bulbulator_salon = communicator.stringToProxy("Bulbulators/bulbulatorSalon:tcp -h localhost -p 10000:udp -h localhost -p 10000")
        bulbulator_salon: IntelligentHouse.BulbulatorPrx = IntelligentHouse.BulbulatorPrx.checkedCast(bulbulator_salon)

        bulbulator_kuchnia = communicator.stringToProxy("Bulbulators/bulbulatorKuchnia:tcp -h localhost -p 10000:udp -h localhost -p 10000")
        bulbulator_kuchnia: IntelligentHouse.BulbulatorPrx = IntelligentHouse.BulbulatorPrx.checkedCast(bulbulator_kuchnia)
        ...
        while True:
            ...
            device = input().strip()
            if device == '1':
                handle_command_bulbulator(bulbulator_salon)
            elif device == '2':
                handle_command_bulbulator(bulbulator_kuchnia)
            elif device == '3':
